...
//	FileUtils.copyFile(screen,new File("//Users//Amit//Desktop//monika"));

}	
public String windowHandleEx()
		{
			driver.get("https://mbuy.ebay.com/xo?action=view&sessionid=493903772016&redirect=mobile");
			driver.findElement("xpath_username").sendKeys("moniksharm35");
			driver.findElement("xpath_pwd").sendKeys("Burlin");
